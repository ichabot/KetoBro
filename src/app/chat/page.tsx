...
export default function ChatPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-4 flex flex-col" style={{ height: "calc(100vh - 64px)" }}>
      <div className="mb-4">
        <h1 className="text-2xl font-bold">🤖 KetoBro Chat</h1>
            ...
            <div className="mt-4 flex flex-wrap gap-2 justify-center">
              {["Wie läuft mein Fortschritt?", "Was ist die Skaldeman Ratio?", "Tipps gegen Keto-Grippe"].map((suggestion) => (
                <button
                  ...
                  className="text-xs bg-white dark:bg-gray-800 border border-green-300 dark:border-green-700 text-green-700 dark:text-green-400 px-3 py-1.5 rounded-full hover:bg-green-100 dark:hover:bg-gray-700 transition-colors"
                >
                  {suggestion}
                </button>
              ))}
      ...
      <form onSubmit={sendMessage} className="flex gap-2 pt-4 border-t">
        <textarea
          ...
          className="flex-1 resize-none rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 min-h-[44px] max-h-[120px]"
          rows={1}
          disabled={sending}
        />
